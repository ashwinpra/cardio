...
| File                                                 | What it covers                                                                       |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [`/AGENTS.md`](../../AGENTS.md)                      | **Start here.** Repo overview, tech stack, dev commands, core patterns               |
...
- **Fixing a bug or adding a feature in one game** → AGENTS.md + that game's file.
- **Adding a new game** → AGENTS.md + architecture.md (see "Adding a Game" section).
...
- Update `AGENTS.md` game table (status/player count) when a game's implementation status changes.
